...
$user_registration_query= "INSERT INTO village(village_name) values ('$village_name');";
...
$user_registration_query= "INSERT INTO bharankan(village_name, nivasi, audhyogik, vanijya) values ('$village_name','$nivasi','$audhyogik','$vanijya');";
  $user_registration_submit= mysqli_query($con, $user_registration_query) or die(mysqli_error($con));
  ...
  $user_registration_query= "INSERT INTO namuna9(village_name, notice_fee, varant_fee, dagdachi_rakkam) values ('$village_name','$notice_fee','$varant_fee','$dagdachi_rakkam');";
  $user_registration_submit= mysqli_query($con, $user_registration_query) or die(mysqli_error($con));
...
$user_registration_query= "INSERT INTO divakar(village_name, o0to300di, o301to700di, o701tosoondi) values ('$village_name','$o0to300d','$o301to700d','$o701tod');";
  $user_registration_submit= mysqli_query($con, $user_registration_query) or die(mysqli_error($con));
...
$user_registration_query= "INSERT INTO arogyakar	(village_name, o0to300ak, o300to700ak, o701tosoonak) values ('$village_name','$o0to300d','$o301to700d','$o701tod');";
  $user_registration_submit= mysqli_query($con, $user_registration_query) or die(mysqli_error($con));
...
$user_registration_query= "INSERT INTO kg(village_name, o0to2y, o3to5y, o6to10y, o11to20y, o21to30y, o31to40y, o41to50y, o51to60y, o60ytosoon) values ('$village_name','$o0to2kg','$o3to5kg','$o6to10kg','$o11to20kg','$o21to30kg','$o31to40kg','$o41to50kg','$o51to60kg','$o60ypjkg');";
  $user_registration_submit= mysqli_query($con, $user_registration_query) or die(mysqli_error($con));
...
$user_registration_query= "INSERT INTO ap(village_name, o0to2y, o3to5y, o6to10y, o11to20y, o21to30y, o31to40y, o41to50y, o51to60y, o60ytosoon) values ('$village_name','$o0to2ap','$o3to5ap','$o6to10ap','$o11to20ap','$o21to30ap','$o31to40ap','$o41to50ap','$o51to60ap','$o60ypjap');";
  $user_registration_submit= mysqli_query($con, $user_registration_query) or die(mysqli_error($con));
...
$user_registration_query= "INSERT INTO mb(village_name, o0to2y, o3to5y, o6to10y, o11to20y, o21to30y, o31to40y, o41to50y, o51to60y, o60ytosoon) values ('$village_name','$o0to2mb','$o3to5mb','$o6to10mb','$o11to20mb','$o21to30mb','$o31to40mb','$o41to50mb','$o51to60mb','$o60ypjmb');";
  $user_registration_submit= mysqli_query($con, $user_registration_query) or die(mysqli_error($con));
...
$user_registration_query= "INSERT INTO ep(village_name, o0to2y, o3to5y, o6to10y, o11to20y, o21to30y, o31to40y, o41to50y, o51to60y, o60ytosoon) values ('$village_name','$o0to2ep','$o3to5ep','$o6to10ep','$o11to20ep','$o21to30ep','$o31to40ep','$o41to50ep','$o51to60ep','$o60ypjep');";
  $user_registration_submit= mysqli_query($con, $user_registration_query) or die(mysqli_error($con));
...
$user_registration_query= "INSERT INTO pg(village_name, o0to2y, o3to5y, o6to10y, o11to20y, o21to30y, o31to40y, o41to50y, o51to60y, o60ytosoon) values ('$village_name','$o0to2pg','$o3to5pg','$o6to10pg','$o11to20pg','$o21to30pg','$o31to40pg','$o41to50pg','$o51to60pg','$o60ypjpg');";
  $user_registration_submit= mysqli_query($con, $user_registration_query) or die(mysqli_error($con));
...
$user_registration_query= "INSERT INTO emaratvkar_dar_1_mulya(village_name, kgm, akm, epm, pm, mm, mkgm, kjm) values ('$village_name','$kgm','$akm','$epm','$pm','$mm','$mkgm','$kjm');";
  $user_registration_submit= mysqli_query($con, $user_registration_query) or die(mysqli_error($con));
...
$user_registration_query= "INSERT INTO emaratvkar_dar_2_kardar(village_name, kgkd, akkd, epkd, pkd, mkd, mkgkd, kjkd) values ('$village_name','$kgkd','$akkd','$epkd','$pkd','$mkd','$mkgkd','$kjkd');";
  $user_registration_submit= mysqli_query($con, $user_registration_query) or die(mysqli_error($con));
...
$user_registration_query= "INSERT INTO panikar(village_name, vae, vpe, spp, pnj) values ('$village_name','$vae','$vpe','$spp','$pnj');";
  $user_registration_submit= mysqli_query($con, $user_registration_query) or die(mysqli_error($con));
