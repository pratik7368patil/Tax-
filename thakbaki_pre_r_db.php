...
//for thakbaki table in database to edit records.
...
$ekun_kar= mysqli_real_escape_string($con, $_POST['ekun_kar']);
 ...
 $user_registration_query= "UPDATE thakbaki SET client_name='$client_name', thak_gharpatti='$thak_gharpatti', chalu_gharpatti='$chalu_gharpatti', ekun_gharpatti='$ekun_gharpatti', thak_divabatti='$thak_divabatti', chalu_divabatti='$chalu_divabatti', ekun_divabatti='$ekun_divabatti', thak_akar='$thak_akar', chalu_akar='$chalu_akar', ekun_akar='$ekun_akar', thak_panikar='$thak_panikar', chalu_panikar='$chalu_panikar', ekun_panikar='$ekun_panikar', notice_fee='$notice_fee', varant_fee='$varant_fee', ekun_kar='$ekun_kar' WHERE ghar_no='$ghar_no' AND village_name='$village_name' ";
...
<html>
    ...
    <body>
        ...
        <div class="container">
        	<div class="jumbotron">
            <center><h2>
              Thakbaki record Edited Successfully.
            </h2></center>
        		<div class="container">
