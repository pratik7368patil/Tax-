...
<body>
    <nav class="navbar navbar-default">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" id="h"><span class="glyphicon glyphicon-plus"></span></a>
                </div>
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav navbar-right">
                      
                      <li><a href="all_client.php" class="btn-lg" id="hy"><span class="glyphicon glyphicon-list"></span> All Clients</a></li>
                      <li><a href="thakbaki_pre_r.php" class="btn-lg" id="hy">Edit Previous Record</a></li>
    ...
    <div class="container">
        <h2>ADD Previous Records</h2>
    </div>
            <div class="container">
<br>
       <form action="thakbaki_add_r_db.php" method="post">
        <div class="container">
            <div class="row">
                <div class="col-sm-4">
            ...
            <br>
            <div class="row">
                <center><button class="btn btn-primary btn-lg">ADD</button></center>
            </div>
        </form>
    </div>
