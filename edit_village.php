    ...
    <nav class="navbar navbar-default">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" id="h"><kbd><span class="glyphicon glyphicon-pencil"></span> EDIT VILLAGE RECORDS.</kbd></a>
                </div>
...
<br>
<form method="post" action="edit_new_village_db_con.php">
<div class="container">
	<center>
    <h2>Master Entry Edit Village</h2>
...
<br>
        ...
        <div class="row">
            <div class="col-sm-6">
               <table class="table table-bordered">
                   ...
                   <tr>
                       <td> औद्योगिक </td>
                       <td> <input type="text" name="audyogik" id="audyogik"> </td>
                   </tr>
                   <tr>
                       <td> वाणिज्यिक </td>
            ...
            <div class="col-sm-6">
                <table class="table table-bordered">
                   ...
                   <tr>
                       <td> नोटीस फी </td>
                       <td> <input type="text" name="notis_fee" id="notis_fee"> </td>
                   </tr>
                   <tr>
                       <td> वारंट फी </td>
                       <td> <input type="text" name="varant fee" id="varant_fee"> </td>
                   </tr>
                   <tr>
                       <td> दगडाची रक्कम </td>
    ...
    <div class="container" id="con2">
        <button class="btn btn-lg btn-success">Edit Village</button>
    </div>
</form>
<footer>
    <div class="container">
